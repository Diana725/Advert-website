  ...
  return (
    <section className="advertising-solutions">
      <div className="container text-center">
        <h1 className="fw-bold fs-2">Advertising Solutions</h1>
        <br />
        <div className="row">
          <div className="col-md-4">
            ...
            <h4 className="fs-5">Targeted Advertising</h4>
          </div>
          <div className="col-md-4">
            <div className="icon">
            ...
            <h4 className="fs-5">Dynamic Ads</h4>
          </div>
          <div className="col-md-4">
            <div className="icon">
            ...
            <h4 className="fs-5">Customer Engagement</h4>
          </div>
        </div>
      </div>
    </section>
