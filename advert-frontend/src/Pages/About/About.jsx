...
const About = () => {
  return (
    <div>
      ...
      <p className="container pt-3 lead fs-6">
        ...
        <div className="container">
          ...
          <section className="info-section">
            <div className="info-box">
              <h2 className="mb-4 fw-bold fs-4">Our Amazing Team</h2>
              <p style={{ fontSize: 14 }}>
            ...
            <div className="info-box">
              <h2 className="mb-4 fw-bold fs-4">
            ...
            <div className="info-box">
              <h2 className="mb-4 fw-bold fs-4">Integrated Marketing</h2>
              <p style={{ fontSize: 14 }}>
            ...
            <div className="info-box">
              <h2 className="mb-4 fw-bold fs-4">Stellar Reputation</h2>
              <p style={{ fontSize: 14 }}>
